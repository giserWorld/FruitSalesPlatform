...
<head>
	...
	<link rel="stylesheet" type="text/css" href="pages/css/retailerHome.css">
...
<body>
				...
				<tbody>
					...
					<c:forEach items="${list}" var="item" varStatus="status">
						<tr>
							...
							<td>
								<a href="javascript:void(0);" class="editBtn" id="${item.retailerid}">编辑</a>
								<a href="javascript:void(0);" class="deleteBtn" id="${item.retailerid}">删除</a>
							</td>
						</tr>
					</c:forEach>
					<c:if test="${list==null}">
					...
					<div style="text-align: center;">
						<table id="xg_info">
							<tbody>
								...
								<tr>
									<td class="td_name">状态：</td>
									<td class="td_value" style="text-align: left;">
		...
		<div class="modal-dialog" style="width: 300px;margin-top: 10%;">
			<div class="modal-content">
				...
				<div class="modal-body" style="text-align: center;">
					...
					<form id="deleteForm" action="retailer/delete.action" method="post">
						<input type="hidden" id="dretailerid" name="retailerid"/>
	...
	$(".deleteBtn").click(function(){
		...
		$("#tj_btn").click(function(){
			...
			var url="http://localhost:8082/FruitSalesPlatform/retailer/updateRetailer.action";
			ajaxRequest(url,param,function(result){
				if(result&&result.code=="0"){
					$("#myModal").modal("hide");
					window.location.href="./retailer/list.action";
				}
			})
		});
		...
		$(".editBtn").click(function(){
			var id=$(this).attr("id");
			$("#myModal").modal("show");
			var url="http://localhost:8082/FruitSalesPlatform/retailer/getDetailById.action"
			var param={
				id:id
			};
